...
//////////////////////////////////////////FUNCIONANDOOOOOOOOOOOOOOOOOOOO
        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style79">Matricula Gestor</td>
                </tr>
                <tr>
                    <td class="auto-style39">Nombre:</td>
                    <td class="auto-style90">
                ...
                <tr>
                    ...
                    <td class="auto-style113">&nbsp;Marcar un check corresponda:</td>
                    <td class="auto-style104">&nbsp;</td>
                </tr>
                <tr>
                    <td class="auto-style68">Fecha de nacimiento:</td>
                    ...
                    <td class="auto-style114">
                        <asp:CheckBoxList ID="CblPersoneria" runat="server">
                ...
                <tr>
                    <td class="auto-style41">Nombre Conyuge</td>
                    <td class="auto-style92">
                        <asp:TextBox ID="txtConyugue" runat="server"></asp:TextBox>
                    </td>
                    <td class="auto-style98">
                        <asp:RequiredFieldValidator ID="rfvConyugue" runat="server" ControlToValidate="txtConyugue" ErrorMessage="no se ingreso nombre"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style43">Apellido Conyuge</td>
                    <td class="auto-style94">
                        <asp:TextBox ID="txtAConyugue" runat="server"></asp:TextBox>
                    </td>
                    <td class="auto-style100">
                        <asp:RequiredFieldValidator ID="rfvApellidoConyugue" runat="server" ControlToValidate="txtAConyugue" ErrorMessage="ingrese apellido"></asp:RequiredFieldValidator>
                    </td>
              ...
              <tr>
                ...
                <tr>
                    <td class="auto-style40">Patente:</td>
                    <td class="auto-style91">
                ...
                <tr>
                    <td class="auto-style40">Cantidad puertas</td>
                    <td class="auto-style91">
                        <asp:Label ID="lblCantpuert" runat="server"></asp:Label>
                    </td>
                    <td class="auto-style109">&nbsp;</td>
                    <td class="auto-style112">&nbsp;</td>
                </tr>

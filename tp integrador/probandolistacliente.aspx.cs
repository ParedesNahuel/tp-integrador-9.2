...
{
    public partial class probandolistacliente : System.Web.UI.Page
    {
        ...
        protected void grdClientes_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string s_estado = ((TextBox)grdClientes.Rows[e.RowIndex].FindControl("txtEstado")).Text;
            ...
            cli.SetEstadoCL(Convert.ToBoolean( s_estado));

          Boolean estado=  neg.ActualizarClientes(cli);
           
            if (estado != true)
            {
                lblConfirmacion.Text = "no funciono";
            }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="probandolistacliente.aspx.cs" Inherits="tp_integrador.probandolistacliente" %>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style10">
                        <asp:GridView ID="grdClientes" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnRowDeleting="grdClientes_RowDeleting" OnRowEditing="grdClientes_RowEditing" OnRowUpdating="grdClientes_RowUpdating" OnRowCancelingEdit="grdClientes_RowCancelingEdit" AllowPaging="True" PageSize="2">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Estado">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtEstado" runat="server" Text='<%# Bind("estado_cl") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblEstado" runat="server" Text='<%# Bind("estado_cl") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
